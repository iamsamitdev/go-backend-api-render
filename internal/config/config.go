...
// ฟังก์ชันช่วยสำหรับดึงค่า environment variable หรือค่าดีฟอลต์
...
// ฟังก์ชันสำหรับดึง PORT สำหรับ Render deployment
func getRenderPort() string {
	// Render ใช้ PORT environment variable
	if port := os.Getenv("PORT"); port != "" {
		return port
	}
	// ถ้าไม่มี PORT ให้ใช้ APP_PORT
